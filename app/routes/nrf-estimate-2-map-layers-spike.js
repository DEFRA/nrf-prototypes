...
const validators = require('../lib/nrf-estimate-2-map-layers-spike/validators')
const buildingTypeHelpers = require('../lib/nrf-estimate-2-map-layers-spike/building-type-helpers')
const {
  ROUTES,
  TEMPLATES
} = require('../config/nrf-estimate-2-map-layers-spike/routes')
const {
  BUILDING_TYPES,
