//
// NRF Estimate Journey Routes - Nature Restoration Fund Levy Estimate (v5)
//
...
const { ROUTES, TEMPLATES } = require('../config/nrf-estimate-5/routes')
const {
  BUILDING_TYPES,
 ...
 * POST /nrf-estimate-5/api/check-edp-intersection
...
router.post(ROUTES.MAP, (req, res) => {
  ...
  try {
    ...
    // Redirect to NO_EDP only when there is no nutrient or GCN intersection
