...
const JOURNEYS = [
  ...
  },
  {
    name: 'NRF Quote 7',
    displayName:
      'Get a quote for Nature Restoration Fund levy (V7, content-driven spike)',
    basePath: '/nrf-quote-7',
    hasStartPage: true,
    description:
      'The V6 quote journey rebuilt from plain content files (content/nrf-quote-7): markdown for copy, YAML for flow. Screens are generated by the journey engine.'
  }
]
