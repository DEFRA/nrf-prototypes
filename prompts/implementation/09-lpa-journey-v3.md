...
- **Journey Route Prefix**: lpa-approve-3
...
| --------------------- | ---------------------------------------------------------- |
| Order number:         | 1                                                          |
| Path:                 | /lpa-approve-3/lpa-approval-email-content                  |
...
[View and approve the Nature Restoration Fund levy](/lpa-approve-3/confirm-view-approve)
...
| -------------------------- | ------------------------------------------------------------------------------- |
| **Order number:**          | 2                                                                               |
| **Path:**                  | /lpa-approve-3/confirm-view-approve                                             |
...
**Button:** Confirm (links to `/lpa-approve-3/lpa-approval-email-magiclink`)
```
...
| --------------------- | -------------------------------------------------------------------------- |
| Order number:         | 3                                                                          |
| Path:                 | /lpa-approve-3/lpa-approval-email-magiclink                                |
...
[View details](/lpa-approve-3/approve-details)
...
| ---------------------- | ------------------------------ |
| Order number:          | 4                              |
| Path:                  | /lpa-approve-3/approve-details |
| Title:                 | Approve these details          |
| Data points:           | None                           |
| Conditional page flow: | Approve → `/lpa-approve-3/lpa-details`; Reject → `/lpa-approve-3/lpa-details-2` |
...
**Button:** Approve (links to `/lpa-approve-3/lpa-details`)
**Button (secondary):** Reject (links to `/lpa-approve-3/lpa-details-2`)
...
| ---------------------- | -------------------------- |
| Order number:          | 5                          |
| Path:                  | /lpa-approve-3/lpa-details |
...
| --------------------- | ------------------------------------ |
| Order number:         | 6                                    |
| Path:                 | /lpa-approve-3/approval-confirmation |
...
[View the email content](/lpa-approve-3/lpa-approval-confirmation-email)
```
...
| --------------------- | -------------------------------------------------------------------- |
| Order number:         | 7                                                                    |
| Path:                 | /lpa-approve-3/lpa-approval-confirmation-email                       |
...
| ---------------------- | ---------------------------- |
| Order number:          | 5b                           |
| Path:                  | /lpa-approve-3/lpa-details-2 |
| Title:                 | Enter your details           |
| H1 heading:            | Enter your details           |
| Conditional page flow: | None                         |
...
CTA: Continue (links to `/lpa-approve-3/reason-for-rejecting`)
```
...
| ---------------------- | --------------------------------------------------------------------------------------- |
| Order number:          | 6b                                                                                      |
| Path:                  | /lpa-approve-3/reason-for-rejecting                                                     |
...
CTA: Continue (links to `/lpa-approve-3/reject-confirmation`)
```
...
| --------------------- | -------------------------------------- |
| Order number:         | 7b                                     |
| Path:                 | /lpa-approve-3/reject-confirmation     |
...
[View the email content](/lpa-approve-3/lpa-rejection-confirmation-email)
```
...
| --------------------- | --------------------------------------------------------------------- |
| Order number:         | 8b                                                                    |
| Path:                 | /lpa-approve-3/lpa-rejection-confirmation-email                       |
...
1. **Route File**: `app/routes/lpa-approve-3.js` (new route file for the LPA approval journey)
2. **View Directory**: `app/views/lpa-approve-3/` (new view directory)
3. **View Files**: One HTML file per page in the journey
4. **Route Config File**: `app/config/lpa-approve-3/routes.js` (route constants)
...
1. **Routes are in** new `app/routes/lpa-approve-3.js` file
2. **Views are in** `app/views/lpa-approve-3/` directory
...
5. **Routes use** centralized route constants from `app/config/lpa-approve-3/routes.js`
6. **Route registration**: Add `const lpaApprove3Routes = require('./routes/lpa-approve-3.js')` and `router.use('/', lpaApprove3Routes)` in `app/routes.js`
...
- **Journey entry point**: Accessed via the payment email issued by the developer payment journey (LPA clicks the link to `/lpa-approve-3/...`)
...
- **Route organization**: Routes in separate `lpa-approve-3.js` file
